"""Pipeline hors ligne Calmap : construit le graphe piéton enrichi de la zone de démo.

Étapes :
1. Télécharge le graphe piéton OSM (Paris + Issy-les-Moulineaux) via OSMnx.
...
# Zone de démo : Paris + Issy-les-Moulineaux
SUD, NORD, OUEST, EST = 48.805, 48.902, 2.220, 2.470
